...
//                System.out.println(whiteRook2Moved);
                if(board[7][7].getIcon()==whiteRook2 &&  this.row == 7 && this.col == 4 && board[7][5].getIcon()==null && board[7][6].getIcon() == null && isSafe(7, 5) && isSafe(7, 6) && !whiteKingMoved && !whiteRook2Moved){
                    return true;
                }
                else{
                    return false;
                ...
                if(board[7][0].getIcon()==whiteRook1 && this.row == 7 && this.col == 4 && board[7][3].getIcon()==null && board[7][2].getIcon() == null && board[7][1].getIcon() == null && isSafe(7, 3) && isSafe(7, 2)  && isSafe(7, 2) && !whiteKingMoved && !whiteRook1Moved){
                    return true;
                }
                else{
                    return false;
            ...
            if(direction.equals("right")){
                if(board[0][7].getIcon()==blackRook2 && this.row == 0 && this.col == 4 && board[0][5].getIcon()==null && board[0][6].getIcon() == null && isSafe(0, 5) && isSafe(0, 6) && !blackKingMoved && !blackRook2Moved){
                    return true;
                }
                else{
                    return false;
                ...
                if(board[0][0].getIcon()==blackRook1 && this.row == 0 && this.col == 4 && board[0][3].getIcon()==null && board[0][2].getIcon() == null && board[0][1].getIcon() == null && isSafe(0, 3) && isSafe(0, 2)  && isSafe(0, 2) && !blackKingMoved && !blackRook1Moved){
                    return true;
                }
                else{
                    return false;
